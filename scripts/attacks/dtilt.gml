...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("whip_ready"));
...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX, sound_get("whip_smacc"));
...
set_hitbox_value(AT_DTILT, 4, HG_HITBOX_Y, -4);
set_hitbox_value(AT_DTILT, 4, HG_WIDTH, 50);
set_hitbox_value(AT_DTILT, 4, HG_HEIGHT, 15);
set_hitbox_value(AT_DTILT, 4, HG_PRIORITY, 2);
set_hitbox_value(AT_DTILT, 4, HG_DAMAGE, 7);
set_hitbox_value(AT_DTILT, 4, HG_ANGLE, 50);
...
set_hitbox_value(AT_DTILT, 4, HG_VISUAL_EFFECT_X_OFFSET, 32);
set_hitbox_value(AT_DTILT, 4, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_DTILT, 4, HG_HIT_SFX, asset_get("sfx_blow_weak1"));
