...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("ropetoss"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, sound_get("ropecatch"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_BASE_HITPAUSE, 4.25);
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, .25);
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("ropeproj"))
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("ropeproj"));
...
//set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_IS_TRANSCENDANT, 1);